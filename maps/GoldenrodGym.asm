...
.StoppedCrying:
    ; Skip straight to reward logic

.SkipCry:
    ; Check if player already got TM45 ATTRACT
...
.GotPlainBadge:
    ...
    ; Farewell text after rewards
    checkevent EVENT_WHITNEY_STOPPED_CRY
    iftrue .Finish

    writetext WhitneyGoodCryText
    waitbutton
    setevent EVENT_WHITNEY_STOPPED_CRY
...
waitbutton
closetext
winlosstext WhitneyWinLossTextRematch, 0
loadtrainer WHITNEY, WHITNEY1
startbattle
reloadmapafterbattle
opentext
writetext WhitneyRematchAfter
waitbutton
closetext
end
...
WhitneyWinLossTextRematch:
	text "Awww! I lost!"
	line "But I won't cry,"
	cont "as I am a tough"
