...
CactusDesertSign1:
	jumptext CactusDesertSign1Text
...
CactusDesert_MapEvents:
	...
	def_warp_events
	warp_event  8, 55, CACTUS_DESERT_CAVE, 3
	warp_event  9, 55, CACTUS_DESERT_CAVE, 4
	...
	def_bg_events
	bg_event 20,  4, BGEVENT_READ, CactusDesertSign1
