...
SaffronCity_MapEvents:
	...
	def_warp_events
	warp_event 24,  3, FIGHTING_DOJO, 1
	...
	object_event 19,  6, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SaffronCityLass2Script, -1
