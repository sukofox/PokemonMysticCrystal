...
DarkCaveBlackthornEntrance_MapEvents:
	...
	warp_event  3,  3, DARK_CAVE_PINE_ENTRANCE1, 1
	...
	object_event  7, 22, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DarkCaveBlackthornEntranceTMSnore, EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_AWAKENING
