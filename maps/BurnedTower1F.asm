...
BurnedTower1F_MapScripts:
	...
	;scene_script BurnedTower1FNoopBScene,      SCENE_BURNEDTOWER1F_BADGE_CHECK
...
;BurnedTower1FNoop3Scene:
	;end

;BurnedTower1FNoop4Scene:
	;end
...
;BurnedTower1FGrannyBadgeCheckScript:
	;turnobject PLAYER, RIGHT
	;sjump _BurnedTower1FGrannyBadgeCheckScript

;BurnedTower1FGrannyScript:
;	faceplayer
;_BurnedTower1FGrannyBadgeCheckScript:
;   opentext
;	writetext BurnedTower1FGrannyText
;	promptbutton
;   readvar VAR_BADGES
;   ifgreater NUM_JOHTO_BADGES - 1, .AllowPass
;   writetext BurnedTower1FGrannyBlockText   ; <-- only write if not enough badges
;    waitbutton
;    closetext
;    applymovement PLAYER, BurnedTower1FGrannyStepBackMovement
;    end

;.AllowPass:
;    writetext BurnedTower1FGrannyAllowText
;    waitbutton
;    closetext
;	setscene SCENE_BURNEDTOWER1F_NOOP4
;    end

;BurnedTower1FGrannyStepBackMovement:
	;step DOWN
	;step_end

;BurnedTower1FGrannyText:
	;text "The spirits only"
	;line "allow the mature"
	;cont "ones to pass..."
	;done

;BurnedTower1FGrannyBlockText:
...
BurnedTower1F_MapEvents:
	...
	warp_event 10,  0, ECRUTEAK_FOREST, 1
	warp_event 11,  0, ECRUTEAK_FOREST, 2

	def_coord_events
	coord_event 11,  9, SCENE_BURNEDTOWER1F_RIVAL_BATTLE, BurnedTowerRivalBattleScript
	;coord_event 10,  1, SCENE_BURNEDTOWER1F_BADGE_CHECK, BurnedTower1FGrannyBadgeCheckScript
	...
	;object_event 11,  1, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BurnedTower1FGrannyScript, -1