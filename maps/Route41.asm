...
Route41_MapEvents:
	...
	warp_event 19, 49, FIR_ISLAND, 1
	warp_event 20, 49, FIR_ISLAND, 1
	...
	object_event 19, 46, SPRITE_OLIVINE_RIVAL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerSwimmermMathew, -1
