...
Route45_MapEvents:
	...
	def_bg_events
	bg_event  8,  2, BGEVENT_READ, Route45Sign
	...
	object_event 17, 65, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 2, TrainerHikerMichael, -1
