...
.Rematch:
	...
	waitbutton
	closetext
	winlosstext FalknerWinLossTextRematch, 0
	loadtrainer FALKNER, FALKNER1
	startbattle
	reloadmapafterbattle
	opentext
	writetext FalknerRematchAfter
	waitbutton
	closetext
	end
...
FalknerWinLossTextRematch:
	text "I lost again."
	line "Darn it!"
	cont "You are stronger."

	para "You have improved"
	line "Keep progressing"
	done
