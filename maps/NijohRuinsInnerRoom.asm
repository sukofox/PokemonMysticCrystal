...
NijohRuinsInnerRoom_MapEvents:
	...
	warp_event  5, 19, NIJOH_RUINS_INTERIOR_2BF, 2
	...
	def_object_events
	object_event  5,  1, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NijohInnerRoomScientistScript, -1
