	...
	tilepal 0, PRIORITY_BROWN, PRIORITY_BROWN, PRIORITY_BROWN, PRIORITY_BROWN, GREEN, GREEN, GREEN, GREEN
	tilepal 0, GREEN, BROWN, BROWN, GREEN, RED, RED, RED, ROOF
	tilepal 0, PRIORITY_BROWN, PRIORITY_BROWN, PRIORITY_BROWN, PRIORITY_BROWN, GREEN, GREEN, GREEN, GREEN
	tilepal 0, GREEN, GREEN, GREEN, GREEN, RED, RED, RED, TEXT
	...
	tilepal 1, BROWN, BROWN, BROWN, GRAY, GRAY, BROWN, YELLOW, BROWN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, GREEN, GREEN, BROWN, BROWN, RED, RED, GREEN, GREEN
	tilepal 1, BROWN, BROWN, RED, RED, BROWN, BROWN, YELLOW, GREEN
	tilepal 1, GREEN, GREEN, GREEN, GREEN, GREEN, BROWN, BROWN, GREEN
	tilepal 1, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, YELLOW, YELLOW
	tilepal 1, GREEN, GREEN, GREEN, GREEN, BROWN, BROWN, BROWN, BROWN
	tilepal 1, BROWN, GREEN, GREEN, RED, YELLOW, YELLOW, YELLOW, YELLOW
