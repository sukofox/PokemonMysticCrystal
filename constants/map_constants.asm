...
; - scripts and events (see data/maps/scripts.asm)
	...
	newgroup NEW_BARK_MEADOW                                      ; 28
    map_const NEW_BARK_MEADOW,                             30,  9 ;  1
    endgroup

	newgroup ECRUTEAK_FOREST									  ; 29
	map_const ECRUTEAK_FOREST,                             10, 25 ;  1
	endgroup
	...
	map_const ECRUTEAK_LIBRARY,								12, 12;  1	
	endgroup	

	newgroup FIR_ISLAND											  ; 32
	map_const FIR_ISLAND,		                            25, 27;  1
	map_const FIR_CAVE, 									10,  9;  2
	endgroup
	
	newgroup FIR_CITY											   ;33
	map_const FIR_NPC_HOUSE,								 6,  5;  1
	map_const SILVER_SANGHA,								11, 10;  2
	map_const FIR_POKE_CENTER,								10,  5;  3
	map_const REFORGED_TOWER_1F,							10,  8;  4
	map_const REFORGED_TOWER_2F,							10,  8;  5
	...
	newgroup DEEP_WOODS											   ;34
	map_const DEEP_WOODS,									16, 17;  1
	map_const PAGODA_OF_TIME,								13, 16;  2
	map_const PAGODA_OF_TIME_1F,							10, 10;  3
	map_const PAGODA_OF_TIME_2F,							10, 10;  4
	map_const PAGODA_OF_TIME_3F,					         8, 10;  5
	map_const ANCIENT_TUNNEL_1F,							 3, 14;  6
	map_const ANCIENT_TUNNEL_2F, 						    10,  4;  7
	endgroup	  

	newgroup PINE_TOWN											   ;35
	map_const DARK_CAVE_PINE_ENTRANCE1,						 8,  6;  1
	map_const DARK_CAVE_PINE_EXIT,							 9,  9;  2
	map_const PINE_NPC_HOUSE,								 6,  5;  3
	map_const PINE_NPC_HOUSE_2,								 5,  4;  4
	map_const PINE_LAB,										10,  6;  5
	map_const PINE_DOJO,									14,  8;  6
	map_const PINE_POKECENTER,								 8,  4;  7
	...
	map_const SILPH_CO_10F,									10, 10;   10
