...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_FIR_CITY
	const ENGINE_FLYPOINT_GOLDENROD
	const ENGINE_FLYPOINT_OLIVINE
	const ENGINE_FLYPOINT_ECRUTEAK
	const ENGINE_FLYPOINT_ALPH_TOWN
	const ENGINE_FLYPOINT_SAGUARO_CITY
	const ENGINE_FLYPOINT_MAHOGANY
	const ENGINE_FLYPOINT_LAKE_OF_RAGE
	const ENGINE_FLYPOINT_BLACKTHORN
	const ENGINE_FLYPOINT_PINE_TOWN
	const ENGINE_FLYPOINT_SPRUCE_CITY
	const ENGINE_FLYPOINT_OLD_ECRUTEAK
