...
DEF JOHTO_LANDMARK EQU const_value
	...
	const LANDMARK_NEW_BARK_MEADOW
	...
	const LANDMARK_DEEP_WOODS
	const LANDMARK_PAGODA_OF_TIME
	...
	const LANDMARK_ECRUTEAK_FOREST
	const LANDMARK_MYSTERIOUS_RUINS
	const LANDMARK_PALACE_OUTSIDE
	const LANDMARK_PALACE_RUINS
	const LANDMARK_OLD_ECRUTEAK
	const LANDMARK_GOLDEN_WOODS
	const LANDMARK_GOLDEN_PAVILION
	const LANDMARK_ECRUTEAK_LIBRARY
	const LANDMARK_ALPH_PATH
	const LANDMARK_ALPH_TOWN
	const LANDMARK_ROUTE_38          ; 19
	const LANDMARK_ROUTE_39          ; 1a
	const LANDMARK_CACTUS_DESERT
	const LANDMARK_SAGUARO_CITY
	const LANDMARK_NIJOH_RUINS
	const LANDMARK_SEASIDE_TRAIL
	const LANDMARK_NIJOH_WOODS
	...
	const LANDMARK_FIR_ISLAND
	const LANDMARK_FIR_CAVE
	const LANDMARK_FIR_CITY
	const LANDMARK_REFORGED_TOWER
	...
	const LANDMARK_SNOW_CANYON
	const LANDMARK_PINE_TOWN					 
