...
; Kanto itemballs
	...
	const EVENT_ROCK_TUNNEL_1F_MAX_REVIVE
...
; New events for mystic crystal
	const EVENT_RUINS_ROOF_RAIKOU
	const EVENT_FOUGHT_RAIKOU
	const EVENT_SET_WHEN_FOUGHT_RAIKOU
	const EVENT_WHITNEY_STOPPED_CRY
	const EVENT_ECRUTEAK_LIBRARY_REVIVE
	const EVENT_FIR_ISLAND_SAGE
	const EVENT_BEAT_KIMONO_GIRL_HINAMI
	const EVENT_BEAT_KIMONO_GIRL_SORA
	const EVENT_BEAT_KIMONO_GIRL_UMIHA
	const EVENT_BEAT_COOLTRAINERM_GERMAN
	const EVENT_BEAT_KIMONO_GIRL_RYOKO
	const EVENT_BEAT_SAGE_GON
	const EVENT_BEAT_KIMONO_GIRL_CHIKO
	const EVENT_BEAT_SAGE_REN
	const EVENT_BEAT_SAGE_TOMA
	const EVENT_BEAT_KIMONO_GIRL_AOI
	const EVENT_BEAT_KIMONO_GIRL_AYA
	const EVENT_BEAT_SAGE_TAI
	const EVENT_BEAT_SAGE_TAKATO
	const EVENT_BEAT_SAGE_YAMATO
	const EVENT_BEAT_SAGE_TAKERU
	const EVENT_BEAT_SAGE_HIROSHI
	const EVENT_BEAT_SAGE_ZEN
	const EVENT_PAGODA_OF_TIME_LEAF_STONE
	const EVENT_PAGODA_OF_TIME_2F_RARE_CANDY
	const EVENT_BEAT_BLACK_BELT_YO
	const EVENT_BEAT_BLACK_BELT_CHOJI
	const EVENT_BEAT_BLACK_BELT_KENTA
	const EVENT_BEAT_BLACK_BELT_FUJI
	const EVENT_BEAT_BLACK_BELT_AKIRA
	const EVENT_GOT_PINE_KABUTO
	const EVENT_BEAT_MEDIUM_RIKA
	const EVENT_BEAT_MEDIUM_AKANE
	const EVENT_BEAT_MEDIUM_KAGOME
	const EVENT_ABANDONED_HOUSE_B1F_MOON_STONE
	const EVENT_BEAT_MEDIUM_YURIKO
	const EVENT_BEAT_SAGE_ITACHI
	const EVENT_BEAT_SAGE_LEORIO
	const EVENT_BEAT_MEDIUM_RIN
	const EVENT_BEAT_SAGE_ZUMI
	const EVENT_FORBIDDEN_PALACE_SAGE_BLOCK
	;const EVENT_FORBIDDEN_PALACE_SAGE_MOVE
	const EVENT_PALACE_ROOF_ENTEI
	const EVENT_FOUGHT_ENTEI
	const EVENT_SET_WHEN_FOUGHT_ENTEI
	const EVENT_BEAT_KIMONO_GIRL_MAMI
	const EVENT_BEAT_KIMONO_GIRL_HOMURA
	const EVENT_BEAT_SAGE_BERN
	const EVENT_BEAT_SAGE_ODA
	const EVENT_BEAT_BUG_CATCHER_LUIGI
	const EVENT_BEAT_BUG_CATCHER_MARIO
	const EVENT_BEAT_BUG_CATCHER_AMRIK
	const EVENT_BEAT_BUG_CATCHER_ANTUAN
	const EVENT_BEAT_YOUNGSTER_SIGMUND
	const EVENT_BEAT_COOLTRAINERF_KARIN
	const EVENT_BEAT_COOLTRAINERM_ARLO
	const EVENT_BEAT_HIKER_GAGAN
	const EVENT_BEAT_HIKER_MILAN
	const EVENT_BEAT_HIKER_JARVIS
	const EVENT_GOT_SAGUARO_OMANYTE
	const EVENT_BEAT_COOLTRAINERF_FRANKY
	const EVENT_BEAT_COOLTRAINERM_JORGE
	const EVENT_BEAT_HIKER_HERVE
	const EVENT_BEAT_FISHER_DANTE
	const EVENT_BEAT_FISHER_ARTHUR
	const EVENT_BEAT_FISHER_ROLF
	const EVENT_BEAT_FISHER_ALON
	const EVENT_BEAT_FISHER_HARI
	const EVENT_BEAT_FISHER_DATU
	const EVENT_BEAT_FISHER_TOMAS
	const EVENT_BEAT_FISHER_JUAN
	const EVENT_BEAT_FISHER_GABO
	const EVENT_BEAT_FISHER_PEPE
	const EVENT_BEAT_FISHER_LUIS
	const EVENT_BEAT_FISHER_PEDRO
	const EVENT_BEAT_FISHER_HULON
	const EVENT_BEAT_BOARDER_ROCKO
	const EVENT_BEAT_SKIER_STACY
	const EVENT_BEAT_SKIER_KATY
	const EVENT_BEAT_SKIER_REGGIE
	const EVENT_BEAT_BOARDER_ISRAEL
	const EVENT_GOT_METAL_COAT_SKATE
	const EVENT_BEAT_BOARDER_OTTO
	const EVENT_BEAT_SKIER_MARTA
	const EVENT_BEAT_SKIER_PEGGY
	const EVENT_BEAT_BOARDER_RAFA
	const EVENT_BEAT_BOARDER_LALO
	const EVENT_BEAT_BOARDER_MICK
	const EVENT_POWER_PLANT_RUINS_2F_ZAPDOS
	const EVENT_FOUGHT_ZAPDOS
	const EVENT_SET_WHEN_FOUGHT_ZAPDOS
	const EVENT_CINNABAR_VOLCANO_CRATER_MOLTRES
	const EVENT_FOUGHT_MOLTRES
	const EVENT_SET_WHEN_FOUGHT_MOLTRES
	const EVENT_SEAFOAM_CAVE_2BF_ARTICUNO
	const EVENT_FOUGHT_ARTICUNO
	const EVENT_SET_WHEN_FOUGHT_ARTICUNO
	const EVENT_SAFARI_ZONE_MEW
	const EVENT_FOUGHT_MEW
	const EVENT_SET_WHEN_FOUGHT_MEW
	const EVENT_CERULEAN_MEWTWO
	const EVENT_FOUGHT_MEWTWO
	const EVENT_SET_WHEN_FOUGHT_MEWTWO
	const EVENT_GOT_KINGS_ROCK_LUCK
	const EVENT_BEAT_FISHER_LUCK
	const EVENT_BEAT_BUG_CATCHER_MARTY
	const EVENT_BEAT_BUG_CATCHER_JET
	const EVENT_BEAT_BUG_CATCHER_GALEN
	const EVENT_BEAT_BUG_CATCHER_SOKKA
	const EVENT_BEAT_LASS_KAZUMI
	const EVENT_EXP_SHARE_PLAYERS_HOUSE_2F
	const EVENT_BEAT_POKEMANIAC_SAUL
	const EVENT_BEAT_POKEMANIAC_MAC
	const EVENT_BEAT_POKEMANIAC_VIC
	const EVENT_BEAT_POKEMANIAC_KOTA
	const EVENT_BEAT_POKEMANIAC_RIKU
	const EVENT_BEAT_SCIENTIST_LOU
	const EVENT_BEAT_SCIENTIST_DICK
	const EVENT_GOT_CELADON_UP_GRADE
	const EVENT_BEAT_POKEMANIAC_PATT
	const EVENT_BEAT_SCIENTIST_RAVI
	const EVENT_BEAT_SCIENTIST_RIC
	const EVENT_BEAT_SCIENTIST_IKKI
	const EVENT_BEAT_SCIENTIST_JAX
	const EVENT_BEAT_SCIENTIST_KOA
	const EVENT_BEAT_SCIENTIST_NOE
	const EVENT_BEAT_SCIENTIST_WES
	const EVENT_BEAT_SCIENTIST_IRA
	const EVENT_SILPH_CO_4F_REVIVE
	const EVENT_SILPH_CO_5F_MAX_POTION
	const EVENT_SILPH_CO_5F_FULL_RESTORE
	const EVENT_SILPH_CO_6F_REVIVE
	const EVENT_SILPH_CO_6F_FULL_HEAL
	const EVENT_BEAT_SCIENTIST_KIT
	const EVENT_BEAT_GUITARIST_LEV
	const EVENT_SILPH_CO_7F_REVIVE
	const EVENT_SILPH_CO_8F_FULL_RESTORE
	const EVENT_BEAT_TEACHER_LULU
	const EVENT_BEAT_SCIENTIST_KYE
	const EVENT_BEAT_SCIENTIST_NEO
	const EVENT_GOT_MASTER_BALL_ENOCH
	const EVENT_BEAT_GENTLEMAN_ENOCH
	const EVENT_POKEMON_MANSION_DRAGONITE
	const EVENT_FOUGHT_SHINY_DRAGONITE
	const EVENT_SET_WHEN_FOUGHT_SHINY_DRAGONITE
	const EVENT_BEAT_BURGLAR_MARION
	const EVENT_POKEMON_MANSION_1F_ESCAPE_ROPE
	const EVENT_BEAT_BURGLAR_LUFFY
	const EVENT_POKEMON_MANSION_2F_MAX_REVIVE
	const EVENT_POKEMON_MANSION_2F_RARE_CANDY
	const EVENT_BEAT_BURGLAR_USOPP
	const EVENT_POKEMON_MANSION_B1F_ULTRA_BALL
	const EVENT_SOUL_BASEMENT_HP_UP
	const EVENT_BEAT_MEDIUM_MARI
	const EVENT_BEAT_MEDIUM_QIN
	const EVENT_BEAT_MEDIUM_YIYAO
	const EVENT_BEAT_MEDIUM_XUE
	const EVENT_BEAT_MEDIUM_RONG
	const EVENT_BEAT_MEDIUM_LAN
	const EVENT_SOUL_BASEMENT_B4F_PARLYZ_HEAL
	const EVENT_BEAT_MEDIUM_HUI
	const EVENT_BEAT_MEDIUM_TING
	const EVENT_BEAT_MEDIUM_XIU
	const EVENT_SOUL_BASEMENT_B5F_AWAKENING
	const EVENT_BEAT_SAGE_CHEN
	const EVENT_NEW_BARK_MEADOW_POTION
	const EVENT_NIJOH_RUINS_2BF_STARDUST
	const EVENT_NIJOH_RUINS_2BF_HYPER_POTION
	const EVENT_BEAT_BUG_CATCHER_MEL
	const EVENT_BEAT_BUG_CATCHER_MILO
	const EVENT_BEAT_BUG_CATCHER_KAI
	const EVENT_ALPH_PATH_GOLD_BERRY
	const EVENT_ALPH_PATH_GOLD_BERRY_2
	const EVENT_ALPH_CASTLE_1F_HEAL_POWDER
	const EVENT_BEAT_SAGE_JUN
	const EVENT_BEAT_SAGE_HAO
	const EVENT_BEAT_SAGE_YU
	const EVENT_ALPH_CASTLE_2F_MIRACLEBERRY
	const EVENT_BEAT_SAGE_LEI
	const EVENT_BEAT_SAGE_MING
	const EVENT_ALPH_CASTLE_ULTRA_BALL
	const EVENT_BEAT_SAGE_AN
	const EVENT_GOT_ALPH_AERODACTYL
	const EVENT_BEAT_SAGE_BO
	const EVENT_MONK_QUARTERS_AWAKENING
	const EVENT_SUPER_NERD_BLOCKS_VIOLET_GYM
	const EVENT_BEAT_BOARDER_PABLO
	const EVENT_BEAT_BOARDER_KIBA
	const EVENT_BEAT_SKIER_NORA
	const EVENT_BEAT_SKIER_SHEYLA
	const EVENT_BEAT_SKIER_JEN
	const EVENT_BEAT_SKIER_EVA
	const EVENT_BEAT_SKIER_PAMMY
	const EVENT_BEAT_BOARDER_KARL
	const EVENT_SNOW_CANYON_ICE_HEAL
	const EVENT_SNOW_CANYON_NUGGET
