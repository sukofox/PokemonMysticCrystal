...
; New events for mystic crystal
	...
	const EVENT_ECRUTEAK_LIBRARY_HISTORIAN
	const EVENT_FIR_ISLAND_SAGE
	const EVENT_FIR_CAVE_FULL_RESTORE
	const EVENT_FIR_CITY_SAGE_1
	const EVENT_FIR_CITY_YOUNGSTER_1
	const EVENT_FIT_CITY_FISHER
	const EVENT_SILVER_SANGHA_GRANNY_1
	const EVENT_SILVER_SANGHA_SAGE_1
	const EVENT_SILVER_SANGHA_SAGE_2
	const EVENT_SILVER_SANGHA_SAGE_3
