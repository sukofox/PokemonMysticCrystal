...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_NEW_BARK_MEADOW
	const PREDEFPAL_ECRUTEAK_FOREST
	const PREDEFPAL_MYSTERIOUS_RUINS
	const PREDEFPAL_ECRUTEAK_LIBRARY
	const PREDEFPAL_FIR_ISLAND
	const PREDEFPAL_FIR_CITY
	const PREDEFPAL_DEEP_WOODS
	const PREDEFPAL_PINE_TOWN
	const PREDEFPAL_GOLDEN_PAVILION
	const PREDEFPAL_BUG_CATCHER_CLUB
	const PREDEFPAL_CACTUS_DESERT
	const PREDEFPAL_SNOW_PATH
	const PREDEFPAL_POWER_PLANT_RUINS
	const PREDEFPAL_CINNABAR_VOLCANO
	const PREDEFPAL_SEAFOAM_CAVE
	const PREDEFPAL_SAFARI_ZONE
	const PREDEFPAL_CERULEAN_CAVE
	const PREDEFPAL_VIRIDIAN_FOREST
	const PREDEFPAL_CELADON_HIDEOUT
	const PREDEFPAL_SILPH_CO
	const PREDEFPAL_POKEMON_MANSION
	const PREDEFPAL_PEWTER_MUSEUM
	const PREDEFPAL_SOUL_BASEMENT
	const PREDEFPAL_ALPH_TOWN
	const PREDEFPAL_SPROUT_GARDEN
	const PREDEFPAL_SNOW_CANYON
