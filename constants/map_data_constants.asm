...
; johto
	...
	const SPAWN_FIR_CITY
	const SPAWN_GOLDENROD
	const SPAWN_OLIVINE
	const SPAWN_ECRUTEAK
	const SPAWN_ALPH_TOWN
	const SPAWN_SAGUARO_CITY
	const SPAWN_MAHOGANY
	const SPAWN_LAKE_OF_RAGE
	const SPAWN_BLACKTHORN
	const SPAWN_PINE_TOWN
	const SPAWN_SPRUCE_CITY
	const SPAWN_OLD_ECRUTEAK
...
DEF JOHTO_FLYPOINT EQU const_value
	...
	const FLY_PINE_TOWN
	const FLY_SPRUCE_CITY
	const FLY_OLD_ECRUTEAK
	const FLY_MT_SILVER
; kanto
