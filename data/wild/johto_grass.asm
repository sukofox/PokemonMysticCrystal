...
JohtoGrassWildMons:
	...
	; New Bark Meadow wild Pokémon

    def_grass_wildmons NEW_BARK_MEADOW
    db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
    ...
    def_grass_wildmons ECRUTEAK_FOREST
    db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
	...
	; Mysterious Ruins wild Pokémon

    def_grass_wildmons MYSTERIOUS_RUINS
    db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
	...
	; Palace Outside wild Pokémon

    def_grass_wildmons PALACE_OUTSIDE
    db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
	...
	; Old Sanctuary wild Pokémon

    def_grass_wildmons OLD_SANCTUARY
    db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
	...
	; Palace Ruins wild Pokémon

    def_grass_wildmons PALACE_RUINS
    db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
