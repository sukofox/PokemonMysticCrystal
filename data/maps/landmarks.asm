...
; entries correspond to constants/landmark_constants.asm
	...
	landmark 132,  28, SpruceCityName
...
NewBarkMeadowName:   db "NEW BARK<BSP>MEADOW@"
EcruteakForestName:  db "ECRUTEAK<BSP>FOREST@"
MysteriousRuinsName: db "MYSTERIOUS<BSP>RUINS@"
...
ReforgedTowerName:   db "REFORGED<BSP>TOWER@"
