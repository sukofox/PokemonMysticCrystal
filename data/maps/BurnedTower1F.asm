...
BurnedTower1FGrannyBadgeCheckScript:
    faceplayer
    opentext
    writetext BurnedTower1FGrannyBlockText
    promptbutton
    readvar VAR_BADGES
...
BurnedTower1FGrannyBlockText:
    text "The spirits tell me"
    line "that you are not"

    para "experienced enough"
	line "to enter here."
...
BurnedTower1F_MapEvents:
	...
	warp_event 10,  0, ECRUTEAK_FOREST, 7
	warp_event 11,  0, ECRUTEAK_FOREST, 7
	...
	object_event 11, 1, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BurnedTower1FGrannyBadgeCheckScript, -1