...
ENDM
	...
	map_attributes Route29, ROUTE_29, $05, NORTH | SOUTH | WEST | EAST 
	connection north, Route46, ROUTE_46, 10
	connection south, NewBarkMeadow, NEW_BARK_MEADOW, -9
	...
	map_attributes NewBarkMeadow, NEW_BARK_MEADOW, $05, NORTH
	connection north, Route29, ROUTE_29, 9 ; adjust offset so the entrance lines up


	map_attributes Route23, ROUTE_23, $03, 0
	...
	map_attributes EcruteakForest, ECRUTEAK_FOREST, $05, 0
	map_attributes MysteriousRuins, MYSTERIOUS_RUINS, $00, 0
	map_attributes PalaceOutside, PALACE_OUTSIDE, $05, 0
	map_attributes OldSanctuary, OLD_SANCTUARY, $00, 0
	map_attributes PalaceRuins, PALACE_RUINS, $00, 0
	map_attributes PalaceRuins2F, PALACE_RUINS_2F, $00, 0
	map_attributes EcruteakLibrary, ECRUTEAK_LIBRARY, $00, 0
	map_attributes FirIsland, FIR_ISLAND, $35, 00
	map_attributes FirCave, FIR_CAVE, $09, 0
	map_attributes FirCity, FIR_CITY, $05, 0
	map_attributes FirNpcHouse, FIR_NPC_HOUSE, $00, 0
	map_attributes SilverSangha, SILVER_SANGHA, $00, 0
	map_attributes FirPokeCenter, FIR_POKE_CENTER, $00, 0
	map_attributes ReforgedTower1F, REFORGED_TOWER_1F, $00, 0
	map_attributes ReforgedTower2F, REFORGED_TOWER_2F, $00, 0
	map_attributes ReforgedTower3F, REFORGED_TOWER_3F, $00, 0
	map_attributes ReforgedTower4F, REFORGED_TOWER_4F, $00, 0
	...
	map_attributes AncientTunnel1F, ANCIENT_TUNNEL_1F, $00, 0
	map_attributes AncientTunnel2F, ANCIENT_TUNNEL_2F, $09, 0
	map_attributes DarkCavePineEntrance1, DARK_CAVE_PINE_ENTRANCE1, $09, 0
	map_attributes PineTown, PINE_TOWN, $71, 0
	map_attributes DarkCavePineExit, DARK_CAVE_PINE_EXIT, $09, 0
	map_attributes PineNPCHouse, PINE_NPC_HOUSE, $00, 0
	map_attributes PineNPCHouse2, PINE_NPC_HOUSE_2, $00, 0
