...
; entries correspond to MAPGROUP_* constants
	...
	dw NewBarkMeadowSprites
	dw EcruteakForestSprites
	dw MysteriousRuinsSprites
	dw EcruteakLibrarySprites
	dw FirIslandSprites
	dw FirCitySprites
	dw DeepWoodsSprites
	dw PineTownSprites
