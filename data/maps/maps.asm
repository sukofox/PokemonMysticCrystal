...
MapGroup_MysteriousRuins:
	...
	map MysteriousRuins, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_MYSTERIOUS_RUINS, MUSIC_FROST_CAVERN_XY, FALSE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_CactusDesert:
	...
	map CactusDesertGate, TILESET_GATE, INDOOR, LANDMARK_ROUTE_39, MUSIC_ROUTE_38, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map NijohWoods, TILESET_FOREST, CAVE, LANDMARK_NIJOH_WOODS, MUSIC_POKEDEX, FALSE, PALETTE_AUTO, FISHGROUP_POND
