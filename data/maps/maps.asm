...
; pointers to the first map of each map group
	...
	dw MapGroup_NewBarkMeadow ; 28
	dw MapGroup_EcruteakForest ; 29
	dw MapGroup_MysteriousRuins ; 30
	dw MapGroup_EcruteakLibrary ; 31
	dw MapGroup_FirIsland ; 32
...
MapGroup_Olivine:
	...
	map OlivineMart, TILESET_MART, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route38EcruteakGate, TILESET_GATE, GATE, LANDMARK_ROUTE_38, MUSIC_ROUTE_38, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route38, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_38, MUSIC_ROUTE_38, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route39, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTE_38, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Ecruteak:
	...
	map EcruteakMart, TILESET_MART, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map BlackthornMart, TILESET_MART, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map Route19FuchsiaGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CinnabarIsland, TILESET_KANTO, TOWN, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR_ISLAND_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Cerulean:
	...
	map CeruleanMart, TILESET_MART, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Azalea:
	...
	map AzaleaMart, TILESET_MART, INDOOR, LANDMARK_AZALEA_TOWN, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map VioletMart, TILESET_MART, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStore1F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore2F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore3F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore4F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore5F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore6F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreElevator, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreRoof, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map VermilionMart, TILESET_MART, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route6SaffronGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMart, TILESET_MART, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Indigo:
	table_width MAP_LENGTH
	map Route23, TILESET_JOHTO_SNOW, TOWN, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map FuchsiaMart, TILESET_MART, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route15FuchsiaGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavenderMart, TILESET_MART, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SoulHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN_RBY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route8SaffronGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_8, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonDeptStore1F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStoreElevator, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route16Gate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7SaffronGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_7, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route17Route18Gate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_17, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianMart, TILESET_MART, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route2Gate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map SaffronMart, TILESET_MART, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route5SaffronGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygroveMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_NewBarkMeadow:
    table_width MAP_LENGTH, MapGroup_NewBarkMeadow
    map NewBarkMeadow, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_MEADOW, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_NONE
    assert_table_length NUM_NEW_BARK_MEADOW_MAPS

MapGroup_EcruteakForest:
	table_width MAP_LENGTH, MapGroup_EcruteakForest
	map EcruteakForest, TILESET_FOREST, ROUTE, LANDMARK_ECRUTEAK_FOREST, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	assert_table_length NUM_ECRUTEAK_FOREST_MAPS

MapGroup_MysteriousRuins:
	table_width MAP_LENGTH, MapGroup_MysteriousRuins
	map MysteriousRuins, TILESET_RUINS, DUNGEON, LANDMARK_MYSTERIOUS_RUINS, MUSIC_FROST_CAVERN_XY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map PalaceOutside, TILESET_JOHTO, ROUTE, LANDMARK_PALACE_OUTSIDE, MUSIC_FROST_CAVERN_XY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map OldSanctuary, TILESET_TRADITIONAL_HOUSE, CAVE, LANDMARK_PALACE_OUTSIDE, MUSIC_ETERNA_FOREST_DPPT, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PalaceRuins, TILESET_TOWER, DUNGEON, LANDMARK_PALACE_RUINS, MUSIC_ETERNA_FOREST_DPPT, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PalaceRuins2F, TILESET_TOWER, ROUTE, LANDMARK_PALACE_RUINS, MUSIC_ETERNA_FOREST_DPPT, FALSE, PALETTE_AUTO, FISHGROUP_NONE

MapGroup_EcruteakLibrary:
	table_width MAP_LENGTH, MapGroup_EcruteakLibrary
	map EcruteakLibrary, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_LIBRARY, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_ECRUTEAK_LIBRARY_MAPS

MapGroup_FirIsland:
	table_width MAP_LENGTH, MapGroup_FirIsland
	map FirIsland, TILESET_JOHTO, ROUTE, LANDMARK_FIR_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map FirCave, TILESET_CAVE, CAVE, LANDMARK_FIR_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	assert_table_length NUM_FIR_ISLAND_MAPS
	
MapGroup_FirCity:
	table_width MAP_LENGTH, MapGroup_FirCity
	map FirNpcHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_FIR_CITY, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilverSangha, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_FIR_CITY, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map FirPokeCenter, TILESET_POKECENTER, INDOOR, LANDMARK_FIR_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ReforgedTower1F, TILESET_TOWER, DUNGEON, LANDMARK_REFORGED_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ReforgedTower2F, TILESET_TOWER, DUNGEON, LANDMARK_REFORGED_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ReforgedTower3F, TILESET_TOWER, DUNGEON, LANDMARK_REFORGED_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ReforgedTower4F, TILESET_TOWER, DUNGEON, LANDMARK_REFORGED_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ReforgedTower5F, TILESET_TOWER, DUNGEON, LANDMARK_REFORGED_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ReforgedTowerRoof, TILESET_TOWER, DUNGEON, LANDMARK_REFORGED_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map FirCity, TILESET_JOHTO, TOWN, LANDMARK_FIR_CITY, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	assert_table_length NUM_FIR_CITY_MAPS

MapGroup_DeepWoods:
	table_width MAP_LENGTH, MapGroup_DeepWoods
	map DeepWoods, TILESET_FOREST, CAVE, LANDMARK_DEEP_WOODS, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PagodaOfTime, TILESET_JOHTO, ROUTE, LANDMARK_PAGODA_OF_TIME, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map PagodaOfTime1F, TILESET_TOWER, INDOOR, LANDMARK_PAGODA_OF_TIME, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map PagodaOfTime2F, TILESET_TOWER, INDOOR, LANDMARK_PAGODA_OF_TIME, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map PagodaOfTime3F, TILESET_TOWER, INDOOR, LANDMARK_PAGODA_OF_TIME, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map AncientTunnel1F, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_PAGODA_OF_TIME, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map AncientTunnel2F, TILESET_CAVE, CAVE, LANDMARK_PAGODA_OF_TIME, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_DEEP_WOODS_MAPS

MapGroup_PineTown:
	table_width MAP_LENGTH, MapGroup_PineTown
	map DarkCavePineEntrance1, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map DarkCavePineExit, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PineNPCHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_PINE_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map PineNPCHouse2, TILESET_HOUSE, INDOOR, LANDMARK_PINE_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map PineLab, TILESET_FACILITY, INDOOR, LANDMARK_PINE_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map PineDojo, TILESET_TOWER, INDOOR, LANDMARK_PINE_TOWN, MUSIC_BURNED_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map PinePokeCenter, TILESET_POKECENTER, INDOOR, LANDMARK_PINE_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_GoldenPavilion:
	...
	map AbandonedHouseA, TILESET_TOWER, DUNGEON, LANDMARK_OLD_ECRUTEAK, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map AbandonedHouse1F, TILESET_TOWER, DUNGEON, LANDMARK_OLD_ECRUTEAK, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map AbandonedHouseB1F, TILESET_TOWER, DUNGEON, LANDMARK_OLD_ECRUTEAK, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map OldEcruteakGate, TILESET_TRADITIONAL_HOUSE, DUNGEON, LANDMARK_OLD_ECRUTEAK, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map GoldenWoods, TILESET_FORESTCUSTOM, CAVE, LANDMARK_GOLDEN_WOODS, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map GoldenWoodsGate, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_GOLDEN_WOODS, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenPavilion, TILESET_JOHTO_ALT, ROUTE, LANDMARK_GOLDEN_PAVILION, MUSIC_FROST_CAVERN_XY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalace, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalace2F, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalaceRoom1, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalaceRoom2, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalaceRoom3, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalaceRoom4, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalaceRoom5, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalaceRoom6, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForbiddenPalace3F, TILESET_TOWER_CUSTOM, DUNGEON, LANDMARK_GOLDEN_PAVILION, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_CactusDesert:
	...
	map CactusDesertCave, TILESET_CAVE, CAVE, LANDMARK_ROUTE_39, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map CactusDesert, TILESET_JOHTO_DESERT, ROUTE, LANDMARK_CACTUS_DESERT, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map DesertSaguaroTownGate, TILESET_GATE, INDOOR, LANDMARK_CACTUS_DESERT, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SaguaroShrine, TILESET_TOWER_CUSTOM, INDOOR, LANDMARK_SAGUARO_CITY, MUSIC_POKEDEX, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SaguaroNPCHouse, TILESET_HOUSE, INDOOR, LANDMARK_SAGUARO_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SaguaroCityDorms, TILESET_MANSION, INDOOR, LANDMARK_SAGUARO_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SaguaroPokeCenter, TILESET_POKECENTER, INDOOR, LANDMARK_SAGUARO_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ArcheologyCenter1F, TILESET_FACILITY, INDOOR, LANDMARK_SAGUARO_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ArcheologyCenter2F, TILESET_FACILITY, INDOOR, LANDMARK_SAGUARO_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ArcheologyCenter3F, TILESET_FACILITY, INDOOR, LANDMARK_SAGUARO_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SaguaroNijohRuinsGate, TILESET_GATE, INDOOR, LANDMARK_SAGUARO_CITY, MUSIC_ROUTE_38, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map NijohRuins, TILESET_JOHTO_DESERT, ROUTE, LANDMARK_NIJOH_RUINS, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map NijohRuinsInterior1F, TILESET_CAVE, CAVE, LANDMARK_NIJOH_RUINS, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map NijohRuinsInterior2BF, TILESET_RUINS, DUNGEON, LANDMARK_NIJOH_RUINS, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map NijohRuinsInnerRoom, TILESET_RUINS, DUNGEON, LANDMARK_NIJOH_RUINS, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map NijohSeasideTrailGate, TILESET_GATE, INDOOR, LANDMARK_SEASIDE_TRAIL, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SeasideTrail, TILESET_JOHTO, ROUTE, LANDMARK_SEASIDE_TRAIL, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SeasideHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_SEASIDE_TRAIL, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map NijohWoodsGate, TILESET_GATE, INDOOR, LANDMARK_SEASIDE_TRAIL, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map NijohWoods, TILESET_FOREST, ROUTE, LANDMARK_NIJOH_WOODS, MUSIC_POKEDEX, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map FisherClub1F, TILESET_FISHER_HOUSE, INDOOR, LANDMARK_NIJOH_WOODS, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map FisherClub2F, TILESET_FISHER_HOUSE, INDOOR, LANDMARK_NIJOH_WOODS, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CianwoodGate, TILESET_GATE, INDOOR, LANDMARK_NIJOH_WOODS, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_SnowPath:
	...
	map SnowPath, TILESET_JOHTO_SNOW, ROUTE, LANDMARK_SNOW_PATH, MUSIC_MOUNT_CORONET_DPPT, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SnowPathGate, TILESET_GATE, INDOOR, LANDMARK_SNOW_PATH, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SnowPathShrine, TILESET_TOWER_CUSTOM, INDOOR, LANDMARK_SNOW_PATH, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SprucePokecenter, TILESET_POKECENTER, INDOOR, LANDMARK_SPRUCE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SpruceNPCHouse1, TILESET_HOUSE, INDOOR, LANDMARK_SPRUCE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SpruceNPCHouse2, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_SPRUCE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SpruceNPCHouse3, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SPRUCE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SpruceMansion1F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SPRUCE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SpruceMansion2F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SPRUCE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SpruceMansion3F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SPRUCE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_PowerPlantRuins:
	...
	map PowerPlantRuins1F, TILESET_UNDERGROUND, DUNGEON, LANDMARK_ROUTE_10, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PowerPlantRuins2F, TILESET_FACILITY, DUNGEON, LANDMARK_ROUTE_10, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_NITE, FISHGROUP_NONE
	assert_table_length NUM_POWER_PLANT_RUINS_MAPS

MapGroup_CinnabarVolcano:
	table_width MAP_LENGTH, MapGroup_CinnabarVolcano
	map CinnabarVolcano, TILESET_CAVE, DUNGEON, LANDMARK_ROUTE_21, MUSIC_LIGHTHOUSE, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_SafariZone:
	...
	map SafariZoneGate, TILESET_GATE, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map SafariZone1, TILESET_FOREST, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SafariZone2, TILESET_JOHTO_ALT, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SafariZone3, TILESET_FOREST, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SafariZone4, TILESET_JOHTO_ALT, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SafariZone5, TILESET_JOHTO_ALT, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map RestingHouse1, TILESET_FACILITY, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map RestingHouse2, TILESET_FACILITY, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map RestingHouse3, TILESET_FACILITY, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_NONE
	assert_table_length NUM_SAFARI_ZONE_MAPS

MapGroup_CeruleanCave:
	table_width MAP_LENGTH, MapGroup_CeruleanCave
	map CeruleanCave, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCave2, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_NITE, FISHGROUP_POND
	map CeruleanCave3, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_NITE, FISHGROUP_POND
	assert_table_length NUM_CERULEAN_CAVE_MAPS

MapGroup_ViridianForest:
	table_width MAP_LENGTH, MapGroup_ViridianForest
	map ViridianForestGate1, TILESET_GATE, INDOOR, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ViridianForest, TILESET_JOHTO_ALT, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ViridianForestGate2, TILESET_GATE, INDOOR, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_VIRIDIAN_FOREST_MAPS
	
MapGroup_CeladonHideout:
	table_width MAP_LENGTH, MapGroup_CeladonHideout
	map CeladonHideoutB1F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CeladonHideoutB2F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CeladonHideoutB3F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CeladonHideoutB4F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_CELADON_HIDEOUT_MAPS

MapGroup_SilphCo:
	table_width MAP_LENGTH, MapGroup_SilphCo
	map SilphCo1F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo2F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo3F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo4F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo5F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo6F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo7F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo8F, TILESET_FACILITY, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo9F, TILESET_FISHER_HOUSE, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo10F, TILESET_FISHER_HOUSE, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo11F, TILESET_FISHER_HOUSE, INDOOR, LANDMARK_SILPH_CO, MUSIC_BLACK_CITY_BW, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_SILPH_CO_MAPS

MapGroup_PokemonMansion:
	table_width MAP_LENGTH, MapGroup_PokemonMansion
	map PokemonMansion1F, TILESET_FISHER_HOUSE, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR_MANSION_RBY, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion2F, TILESET_FISHER_HOUSE, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR_MANSION_RBY, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion3F, TILESET_FISHER_HOUSE, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR_MANSION_RBY, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansionB1F, TILESET_FISHER_HOUSE, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR_MANSION_RBY, FALSE, PALETTE_NITE, FISHGROUP_NONE
	assert_table_length NUM_POKEMON_MANSION_MAPS

MapGroup_PewterMuseum:
	table_width MAP_LENGTH, MapGroup_PewterMuseum
	map PewterMuseum1F, TILESET_GATE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map PewterMuseum2F, TILESET_GATE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_PEWTER_MUSEUM_MAPS


MapGroup_SoulBasement:
	table_width MAP_LENGTH, MapGroup_SoulBasement
	map SoulBasementB1F, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB2F, TILESET_HOUSE, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB3F, TILESET_HOUSE, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB4F, TILESET_HOUSE, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB5F, TILESET_HOUSE, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB6F, TILESET_HOUSE, DUNGEON, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_SOUL_BASEMENT_MAPS

MapGroup_AlphTown:
	table_width MAP_LENGTH, MapGroup_AlphTown
	map CherrygroveAlphPathGate, TILESET_GATE, GATE, LANDMARK_ALPH_PATH, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphPath, TILESET_FORESTCUSTOM, CAVE, LANDMARK_ALPH_PATH, MUSIC_ETERNA_FOREST_DPPT, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map AlphPathAlphTownGate, TILESET_GATE, GATE, LANDMARK_ALPH_PATH, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphTownNPCHouse1, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphTownNPCHouse2, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphTownPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphTownMart, TILESET_MART, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_MART_HGSS, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphCastle1F, TILESET_TOWER, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphCastle2F, TILESET_TOWER, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphCastleB1F, TILESET_TOWER, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphCastleRoom1, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_SPROUT_TOWER, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map AlphCastleRoom2, TILESET_TOWER, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphCastleRoom3, TILESET_TOWER, INDOOR, LANDMARK_ALPH_TOWN, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AlphTown, TILESET_FORESTCUSTOM, TOWN, LANDMARK_ALPH_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	assert_table_length NUM_ALPH_TOWN_MAPS

MapGroup_SproutGarden:
	table_width MAP_LENGTH, MapGroup_SproutGarden
	map SproutTowerB1F, TILESET_TOWER, INDOOR, LANDMARK_SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SproutTowerExit, TILESET_TOWER, INDOOR, LANDMARK_SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SproutGarden, TILESET_JOHTO_ALT, ROUTE, LANDMARK_SPROUT_TOWER, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MonkQuarters, TILESET_TOWER, DUNGEON, LANDMARK_SPROUT_TOWER, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
