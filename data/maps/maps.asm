...
MapGroup_SoulBasement:
	...
	map SoulBasementB2F, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB3F, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB4F, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB5F, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SoulBasementB6F, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER_RBY, FALSE, PALETTE_DAY, FISHGROUP_NONE
