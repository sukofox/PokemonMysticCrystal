...
MapGroup_CeruleanCave:
	...
	map CeruleanCave, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCave2, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_POND
	map CeruleanCave3, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_CeladonHideout:
	...
	map CeladonHideoutB1F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CeladonHideoutB2F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CeladonHideoutB3F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CeladonHideoutB4F, TILESET_UNDERGROUND, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_CELADON_HIDEOUT_MAPS

MapGroup_SilphCo:
	table_width MAP_LENGTH, MapGroup_SilphCo
	map SilphCo1F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo2F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo3F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo4F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo5F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo6F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo7F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo8F, TILESET_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo9F, TILESET_FISHER_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo10F, TILESET_FISHER_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCo11F, TILESET_FISHER_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEDEX, FALSE, PALETTE_DAY, FISHGROUP_NONE
