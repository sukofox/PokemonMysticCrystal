...
; Johto
	...
	db LANDMARK_ALPH_TOWN,		  SPAWN_ALPH_TOWN
	db LANDMARK_SAGUARO_CITY,	  SPAWN_SAGUARO_CITY
	db LANDMARK_OLIVINE_CITY,     SPAWN_OLIVINE
	db LANDMARK_CIANWOOD_CITY,    SPAWN_CIANWOOD
	db LANDMARK_FIR_CITY,		  SPAWN_FIR_CITY
	...
	db LANDMARK_PINE_TOWN,		  SPAWN_PINE_TOWN
	db LANDMARK_SPRUCE_CITY,	  SPAWN_SPRUCE_CITY
	db LANDMARK_OLD_ECRUTEAK,     SPAWN_OLD_ECRUTEAK
